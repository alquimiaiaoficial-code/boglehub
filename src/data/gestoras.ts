...
export const GESTORAS: Gestora[] = [
  {
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'VWCE (Vanguard FTSE All-World UCITS ETF Acc, ISIN IE00BK5BQT80) es el ETF más popular entre inversores indexados españoles. Incluye más de 3.700 empresas de mercados desarrollados y emergentes en un solo producto, con TER 0,14% y política de acumulación. Disponible en Trade Republic, DEGIRO y la mayoría de brokers europeos.',
      },
      {
