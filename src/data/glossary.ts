...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    example:
      'VWCE (Vanguard FTSE All-World) es un ETF que invierte en más de 3.700 empresas globales. Si compras 100 participaciones a 100€, posees una fracción microscópica de cada una de esas empresas, con un coste anual de gestión del 0,14% (TER).',
    relatedArticles: [
