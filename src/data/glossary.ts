...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    category: 'fiscalidad',
    shortDefinition:
      'Hacienda no permite computar una pérdida si recompras el mismo valor (o equivalente) poco después de venderlo: dos meses si cotiza, como un ETF; en fondos no cotizados lo prudente es contar doce.',
    longDefinition:
