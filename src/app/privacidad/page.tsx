    ...
    <>
      ...
      <main className="bg-bg min-h-screen">
        <article className="mx-auto max-w-3xl px-4 sm:px-6 py-16 prose prose-invert prose-zinc">
          ...
          <p><strong>Contacto:</strong> boglehub@gmail.com</p>
          ...
          <ul>
            ...
            <li><strong>Datos técnicos durante el análisis:</strong> al pulsar &quot;Analizar&quot;, tus posiciones viajan a nuestro servidor y de ahí al proveedor de IA, que genera el comentario en texto. Si además rellenas la proyección de independencia financiera, <strong>tu aportación mensual y tu objetivo de patrimonio viajan solo a nuestro servidor</strong>, que calcula la proyección: <strong>no se envían al proveedor de IA</strong>, que recibe únicamente el resultado (los años estimados). Todo se descarta al terminar y no se asocia a ti.</li>
          ...
          <p>Para consultas sobre privacidad: boglehub@gmail.com</p>
