        ...
        <div className="mx-auto max-w-3xl px-4 sm:px-6 py-10">
          ...
          <section className="mb-8">
            ...
            <ul className="space-y-2 text-sm text-fg-muted">
              ...
              <li className="flex gap-2"><span className="text-accent shrink-0">•</span><span><strong className="text-fg">Spanish savings tax (IRPF):</strong> 19% up to €6,000, 21% up to €50,000, 23% up to €200,000, 27% up to €300,000, 28% above. Applied on realized capital gains.</span></li>
