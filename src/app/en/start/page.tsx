...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'For most beginners, VWCE (Vanguard FTSE All-World UCITS ETF Acc, ISIN IE00BK5BQT80) is the simplest choice. It includes 3,700+ companies globally (developed + emerging markets), TER 0.14%, accumulation policy, domiciled in Ireland for tax efficiency. Available in Trade Republic with automatic savings plans from €1/month.',
  },
]
