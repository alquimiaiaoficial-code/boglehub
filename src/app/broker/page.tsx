...
export const metadata: Metadata = {
  ...
  description: `Comparativa de los ${BROKERS.length} mejores brokers para invertir en ETFs desde España: Trade Republic, DEGIRO, MyInvestor, XTB e IBKR. Comisiones y para quién es cada uno.`,
  alternates: {
    canonical: '/broker',
